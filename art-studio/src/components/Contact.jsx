    ...
    return(
        ...
        <div className="mid-side">
            ...
            <form action="#" className="contact-form">
                ...
                <input type="text" id="name" name="name" placeholder="Иван Иванов" className="text-input" />

                <label for="mail" className="form-label">Почта</label>
                <input type="email" id="mail" name="mail"  placeholder="example@mail.ru" className="text-input" />

                <label for="isCompany" className="form-label">Вид юр. лица</label>
                ...
                <input type="checkbox" name="agreement" id="agreement" className="check-input" />
